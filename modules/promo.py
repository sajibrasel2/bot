...
GIRL_NAMES = [
    ...
    "রিতু", "পায়রা", "হিমি", "তনু", "শম্পা", "রুহি", "নাদিয়া", "সামিয়া",
    "আফরিন", "ফারিয়া", "নিশাত", "রুবিনা", "শবনম", "মহিমা", "দিয়া", "পিংকি",
    "ঝুমুর", "পপি", "রিনা", "তন্বী", "সূচনা", "স্বর্ণা", "চম্পা", "বিথী",
    "রজনী", "শিউলি", "বকুল", "টুম্পা", "রুমানা", "মাহি", "রাইসা", "আইরিন",
    "জয়া", "শ্রাবণী", "মুনতাহা", "মায়িশা", "তানিশা", "সুমনা", "তামান্না", "নাজনীন",
    "মেহেরুন", "শারমিন", "সুস্মিতা", "অদিতি", "অনামিকা", "অনুরাধা", "অন্তরা", "উপমা",
    "এঞ্জেলা", "কনক", "কনা", "কাকলী", "চৈতী", "জিনিয়া", "ডালিয়া", "তানজিলা",
    "তৃষা", "দিশা", "নিশি", "নীলা", "পারভীন", "পিউ", "পুষ্পিতা", "ফাতেমা",
    "ফারজানা", "বনশ্রী", "বর্ষা", "বাবলি", "বিপাশা", "মল্লিকা", "মিথিলা", "মুসকান",
    "মোহনা", "যুথী", "রাখি", "রোকেয়া", "লতা", "লিজা", "শায়লা", "শিরিন",
    "সানজিদা", "সীমা", "সুরভী", "সেঁজুতি", "হেনা", "আয়েশা", "জুলেখা", "রুকাইয়া"
]
...
DISTRICTS = [
    ...
    "কুড়িগ্রাম", "নীলফামারী", "গাইবান্ধা", "লালমনিরহাট", "পঞ্চগড়", "ঠাকুরগাঁও", "জয়পুরহাট",
    "চাঁপাইনবাবগঞ্জ", "মেহেরপুর", "নড়াইল", "রাজবাড়ী", "মাদারীপুর", "শরীয়তপুর", "শেরপুর",
    "খাগড়াছড়ি", "রাঙ্গামাটি", "বান্দরবান", "বরগুনা", "পিরোজপুর", "ঝালকাঠি"
]
...
STATUSES = [
    ...
    "তোমার সাথে একটু মনের কথা বলতে চাই জান...",
    "অনলাইনে লাইভ রুমে অপেক্ষা করছি, দেরি করো না...",
    "মন খারাপ তাই অনলাইনে এসেছি, একটু গল্প করবে?",
    "একদম ফ্রি আছি এখন, ইমোতে সরাসরি কল দাও সোনা...",
    "ভিআইপি সিক্রেট রুমে সরাসরি ভিডিও কলে কথা বলব...",
    "লাইভ আড্ডা ও স্পেশাল কোয়ালিটি টাইম কাটাতে ইনবক্স করো..."
]
